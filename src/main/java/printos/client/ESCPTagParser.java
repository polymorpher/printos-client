 ...
 */
public class ESCPTagParser implements AbstractTagParser {
...
//    static String PRTCMD_GIGANTIC_TEXT = PRTCMD_FONT_DOUBLE_WIDTH;
    ...
    public boolean validate(String s) throws InvalidTagException, BadFormatException {
        if (s == null)
            throw new BadFormatException("Empty input. Please consult with API documentation and verify that field names match with the requirement.");
